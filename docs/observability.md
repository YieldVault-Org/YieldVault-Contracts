...
This note documents the **observability** of the yieldvault-contract contract.

yieldvault-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the observability in detail, covering the relevant
