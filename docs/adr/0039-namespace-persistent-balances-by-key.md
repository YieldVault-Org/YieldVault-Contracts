...
The YieldVault smart contract needs a clear, documented approach to "namespace persistent balances by key" so the codebase stays consistent and auditable.
