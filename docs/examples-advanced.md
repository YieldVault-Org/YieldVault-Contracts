...
This note documents the **examples-advanced** of the yieldvault-contract contract.

yieldvault-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the examples-advanced in detail, covering the relevant
