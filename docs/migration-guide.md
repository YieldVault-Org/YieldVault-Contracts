...
This note documents the **migration-guide** of the yieldvault-contract contract.

yieldvault-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the migration-guide in detail, covering the relevant
