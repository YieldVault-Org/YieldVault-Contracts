...
This note documents the **state-transitions** of the yieldvault-contract contract.

yieldvault-contract is a Soroban smart contract on the Stellar network. This page is part of the
project's reference documentation and describes the state-transitions in detail, covering the relevant
